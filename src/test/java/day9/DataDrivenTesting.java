...
public class DataDrivenTesting {
	...
	{
		orderSubmission(bookId,CustomerName);
	}
	...
	{
		orderSubmission(data.get("BookID"),data.get("CustomerName"));
	}
	...
	public void orderSubmission(String bookId, String CustomerName)
	{
		
		HashMap<String,Object> orderData = new HashMap<String,Object>();
		orderData.put("bookId", Integer.parseInt(bookId));
